...
adj_s, features_s, labels_s = load_data_blog(dataset=args.data_src)
adj_t, features_t, labels_t = load_data_blog(dataset=args.data_trg)
...
for epoch in range(args.n_epoch):
    ...
    if (epoch+1)%50 == 0:
        print('epoch: {}, acc_test_trg: {},loss:{},loss_in:{},loss_out:{}'.format(epoch,acc_trg,loss,loss_intra,loss_inter))
